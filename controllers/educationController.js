...
const { Education } = db;
// Configura o serviço para o modelo Education, ordenando pela data de fim (mais recente primeiro)
const service = createCrudService(Education, { order: [['end_date', 'DESC']] });
